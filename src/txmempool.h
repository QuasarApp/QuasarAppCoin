...
public:
     ...
     * https://github.com/quasarappcoin/quasarappcoin/pull/14193 will fix it. No known code
     * in quasarappcoin currently depends on second guarantee, but it is important to
