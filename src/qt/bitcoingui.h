...
/**
  QuasarAppcoin GUI main class. This class represents the main window of the QuasarAppcoin UI. It communicates with both the client and
...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a quasarappcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
